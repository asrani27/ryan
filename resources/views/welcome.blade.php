...
<body class="hold-transition bg-teal-active layout-top-nav">
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top"  style="box-shadow: 0 8px 8px 0 rgba(0,0,0,.2);">
      <div class="container">
        <div class="navbar-header">
          <a href="#" class="navbar-brand"><b>SISTEM INFORMASI PENILAIAN KINERJA PEGAWAI</b></a>
  ...
  <!-- Full Width Column -->
  <div class="content-wrapper"  style="background-image: url('/logo/b.png'); background-size:cover">
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="text-center">
              <br/><br/>
              <img src="/logo/main.png" width="50%">
            </div>
          <br/><br/>
            <div class="box">
              <div class="box-header text-center bg-teal-active ">
                <h3 class="box-title">KINERJA PEGAWAI </h3>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-3 control-label" style="color:black">Password</label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <button type="submit" class="btn bg-teal-active btn-block"><i class="fa fa-sign-out"></i> Sign In</button>
                  </div>
                </div>
              </div>
              </form>
