...
<div class="row">
    <div class="col-md-12">
        <a href="/superadmin/penilaian/skp" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Kembali</a> <br /><br />
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="box box-success">
            <div class="box-header">
                ...
                <h3 class="box-title">Nilai SKP</h3>
            </div>
            <!-- /.box-header -->
            <form class="form-horizontal" method="post" action="/superadmin/penilaian/skp/edit/{{$data->id}}">
                @csrf
