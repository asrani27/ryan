...
<div class="row">
    <div class="col-md-12">
        <a href="/superadmin/penilaian/perilaku" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Kembali</a> <br /><br />
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="box box-success">
            <div class="box-header">
                ...
                <h3 class="box-title">Nilai perilaku</h3>
            </div>
            <!-- /.box-header -->
            <form class="form-horizontal" method="post" action="/superadmin/penilaian/perilaku/edit/{{$data->id}}">
                @csrf
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">Nilai Perilaku</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="nilai_perilaku" value="{{$data->nilai_perilaku}}" required>
                    </div>
                </div>
                <div class="form-group">
